...
export const broadKeywordPattern = /^(대한민국|한국|국내|해외|미국|일본|중국|서울|시장|기업|회사|제품|서비스|기술|이슈|문제|상황|코스피|주식|경제)$/i;
...
export const stopWords = new Set('최근 오늘 이번 사람들 사람입니다 관련 영상 사진 있는 없는 하는 하는 가장 진짜 그냥 이유 얼마나 대박 ㄷㄷ jpg gif vs the and of will with from this that about 현재 방금 근황 있습니다 입니다 했던 썼던 풀었다는 따르면 밝혔다 공개 시작 공포에 터졌는데 키운다 소비와 mp4'.split(' '));
...
export const genericKeywords = new Set('한국 국내 해외 미국 일본 중국 서울 코리아 대한민국 사람 사용자 소비자 아이 부모 회사 기업 시장 가격 브랜드 제품 서비스 기술 업계 이슈 문제 결과 상황 종목 모두 모바일 인터넷 지역 계획 트렌드 코스피 경제 주식'.split(' '));
