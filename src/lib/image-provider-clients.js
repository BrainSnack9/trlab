...
async function generateDeepInfra(prompt, key) {
  const body = { prompt, size: process.env.IMAGE_SIZE ?? '1024x1024', n: 1, response_format: 'b64_json' };
...
function openAIModels() {
  return [...new Set([process.env.OPENAI_IMAGE_MODEL, 'gpt-image-1.5', 'gpt-image-1', 'gpt-image-1-mini'].filter(Boolean))];
}
