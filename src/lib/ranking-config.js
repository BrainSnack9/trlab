export const sourceWeights = {
  'Google Trends': 18, 'Search SERP': 18, FMKorea: 14, TheQoo: 12,
  'Nate Pann': 12, Reddit: 11, DCInside: 10, Ruliweb: 9, ArcaLive: 9,
  Inven: 8, BobaeDream: 8, MLBPark: 7, Clien: 7
};
...
export const stopWords = new Set('최근 오늘 이번 사람들 관련 영상 사진 있는 없는 하는 하는 가장 진짜 그냥 이유 얼마나 대박 ㄷㄷ jpg gif vs the and of will with from this that about 현재 방금 근황 있습니다 공개 시작 mp4'.split(' '));
...
export const genericKeywords = new Set('한국 국내 해외 미국 일본 중국 서울 코리아 사람 사용자 아이 부모 회사 기업 시장 가격 브랜드 제품 서비스 기술 업계 이슈 문제 결과 상황 종목 모두 모바일 인터넷 지역 계획 트렌드'.split(' '));
