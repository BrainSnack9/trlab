...
export const collectableSourceIds = [
  ...
  'reddit', 'ruliweb', 'inven', 'arcalive', 'mlbpark', 'clien'
];
...
export const sourceNameById = {
  ...
  inven: 'Inven', arcalive: 'ArcaLive', mlbpark: 'MLBPark', clien: 'Clien'
};

export const sourceMetaById = {
  google: ['검색 트렌드', 'Google Trends RSS'], serp: ['검색 트렌드', 'Google News RSS'],
  dcinside: ['커뮤니티', '공개 인기글'], fmkorea: ['커뮤니티', '포텐터짐'],
  theqoo: ['커뮤니티', '핫 게시글'], natepann: ['커뮤니티', '실시간 랭킹'],
  bobaedream: ['커뮤니티', '베스트글'], reddit: ['글로벌 커뮤니티', '서브레딧 RSS'],
  ruliweb: ['커뮤니티', '실시간 베스트'], inven: ['게임/테크', '게임 뉴스'],
  arcalive: ['커뮤니티/서브컬처', '채널 베스트'], mlbpark: ['커뮤니티', '불펜'],
  clien: ['커뮤니티', '모두의공원']
};
